...
1. Clone o repositório do Projeto [Conta Bancária](https://github.com/scaglia-aylla1/Conta-Bancaria.git) dentro da pasta do *Workspace* do Eclipse/STS

```bash
git clone https://github.com/scaglia-aylla1/Conta-Bancaria.git
```
